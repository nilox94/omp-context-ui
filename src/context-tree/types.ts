...
export type BlockKind = "thinking" | "text" | "tool-call" | "tool-result" | "image" | "custom";
...
export type ContextTreeNode = ContextCategoryNode | ContextMessageNode | ContextBlockNode | ContextLeafNode;
